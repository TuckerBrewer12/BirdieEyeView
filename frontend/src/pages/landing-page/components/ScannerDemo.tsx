...
export function ScannerDemo() {
  ...
  return (
    <div className="perspective-1000 relative flex aspect-[4/3] w-full max-w-lg items-center justify-center overflow-hidden rounded-2xl border border-border bg-card shadow-card sm:aspect-11/10">
      <motion.img
