                ...
                {recentDistribution.length > 0 ? (
                  <ResponsiveContainer width="100%" height={200}>
                    <BarChart data={recentDistribution} margin={{ top: 4, right: 4, left: -24, bottom: 0 }}>
                      ...
                      <XAxis dataKey="label" tick={{ fontSize: 9, fill: "var(--chart-axis)", fontWeight: 700 }} tickLine={false} axisLine={false} />
                      <YAxis tick={{ fontSize: 10, fill: "var(--chart-axis)", fontWeight: 700 }} tickLine={false} axisLine={false} unit="%" />
